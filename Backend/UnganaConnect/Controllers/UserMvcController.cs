...
namespace UnganaConnect.Controllers
{
    public class UserMvcController : Controller
    {
        ...
        public UserMvcController(UnganaConnectDbcontext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Email,PasswordHash,FirstName,LastName,CreatedAt,Role")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
